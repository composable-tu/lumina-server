...
import org.lumina.fields.ReturnInvalidReasonFields.INVALID_WEIXIN_OPEN_ID
...
fun Routing.weixinAuthRoute(appId: String, appSecret: String) {
    route("/weixin") {
        post("/login") {
            ...
            val weixinOpenId = weixinUserInfo.openid ?: throw LuminaBadRequestException(INVALID_WEIXIN_OPEN_ID)
